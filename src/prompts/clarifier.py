...
clarifier_prompt = ChatPromptTemplate.from_messages([
    ("system", """You are an Expert Research Architect. Your objective is to evaluate a user's research request and determine if it is "actionable" for a downstream autonomous Planning Agent.

Your goal is NOT to do the research, but to ensure the scope is surgically precise. 
